...
UINT64 instrCount = 0;
UINT64 Warmup_instructions=343107;
UINT64 Simulation_instructions=13771;
trace_instr_format_t last_instr;
...
{
  if(instrCount<Warmup_instructions){
    curr_instr.extra_bit = 0;
  }
  else if((instrCount < Warmup_instructions + Simulation_instructions)){
