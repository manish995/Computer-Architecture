...
int Warmup_instructions = 343107;
int Simulation_instructions = 13755;
...
void write_int_to_file(int temp){
  char arr[32];
  for(int i=0;i<32;i++){
    arr[i]='0';
  }
...
int main(int argc, char *argv[])
{
    ...
    write_int_to_file(Warmup_instructions);
    write_int_to_file(Simulation_instructions);
